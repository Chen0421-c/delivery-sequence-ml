...
Avoid multi-vehicle routing, multi-depot routing, deep reinforcement learning, Transformer/pointer networks, LLM route generation, and full production dashboards unless requested later.
...
3. Implement Actual Route, Nearest Neighbour, and OR-Tools TSP baselines.
4. Build Random Forest next-stop prediction model.
...
8. Create a Colab notebook that runs the full MVP on 100-300 routes.
